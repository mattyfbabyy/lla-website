...
function buildEbook() {
  ...
  <div class="wrap hs-grid">
    <div class="rv in">
      ...
      <form class="optform optform-stack optform-left" data-optin><input type="text" name="firstname" placeholder="First name" required><input type="email" placeholder="Your best email" required><button class="btn btn-gold" type="submit">${e.formButton}</button></form>
